...
public class StoreConverter {
    ...
    public static ReviewDto.PreviewRequestDto reviewPreViewDTO(Review review){
        return ReviewDto.PreviewRequestDto.builder()
    ...
    public static ReviewDto.ReviewResponseDto reviewPreViewListDTO(Page<Review> reviewList){
        List<ReviewDto.PreviewRequestDto> reviewPreViewRequestDTOList = reviewList.stream()
        ...
        return ReviewDto.ReviewResponseDto.builder()
                ...
                .listSize(reviewPreViewRequestDTOList.size())
                .reviewList(reviewPreViewRequestDTOList)
                .build();
    }
