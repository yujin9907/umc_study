...
public class QStore extends EntityPathBase<Store> {
    ...
    public final ListPath<Storeimage, QStoreimage> iamges = this.<Storeimage, QStoreimage>createList("iamges", Storeimage.class, QStoreimage.class, PathInits.DIRECT2);
